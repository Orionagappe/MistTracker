...
globalIllumination     // Wave-based global illumination using interference and metric tensors (see pureMathPhysicsEngine.js)
...
eulerLagrange          // Euler-Lagrange equation for wave function (see pureMathPhysicsEngine.js)
